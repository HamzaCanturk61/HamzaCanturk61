...
[![Website](https://img.shields.io/badge/Website-FF7139?style=for-the-badge&logo=firefox-browser&logoColor=white)](https://hamzacanturk.com/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:info@hamzacanturk.com)

Yeni mezun bir Bilgisayar Mühendisi olarak, modern yazılım teknolojileri ve **yapay zeka destekli geliştirme araçları** ile kendimi sürekli geliştirmeye odaklanıyorum. Yazılım geliştirme süreçlerimde Clean Architecture, SOLID prensipleri ve Repository Pattern gibi mimari yaklaşımları uyguluyorum. ASP.NET Core ve Entity Framework Core ile veritabanı entegrasyonları, JWT tabanlı kimlik doğrulama ve rol bazlı yetkilendirme konularında projeler geliştirdim.

Frontend ve mobil geliştirme alanında, React Native ve Expo teknolojileri ile çalışarak çok platformlu uygulama geliştirme deneyimi kazandım. Geliştirme süreçlerimde **Claude Code, Gemini CLI, Cursor ve Windsurf** gibi yapay zeka destekli programlama araçlarını kullanarak verimliliği artırmayı hedefliyorum. Ayrıca, xUnit ve Moq kütüphaneleriyle birim ve entegrasyon testleri geliştirerek kalite odaklı yazılım üretimine önem veriyorum.

## 🚀 Öne Çıkan Projeler

### 🤖 FaceOptic AI-Platform
**Teknolojiler:** ASP.NET Core MVC, Azure Face API, Google Vision AI, ChatGPT, Claude AI, Entity Framework Core, Iyzico

AI destekli e-ticaret platformu. Yapay zeka servisleri ile yüz şekli analizi ve kişiselleştirilmiş gözlük önerileri. Çoklu AI servis entegrasyonu ile yüksek doğruluk oranı sağlandı.

### 🎮 WordGameApp - Çok Platformlu Kelime Oyunu
**Teknolojiler:** ASP.NET Core API, React Native Expo, JWT, xUnit/Moq, Clean Architecture
...
Gamification yaklaşımı ile dil öğrenme deneyimi. Kelime öğrenme, eşleştirme oyunu ve ilerleme takip sistemi.

### 🛒 MakTek E-Commerce Platform
**Teknolojiler:** ASP.NET Core MVC, Repository Pattern, Identity Framework, EF Core

Kurumsal e-ticaret platformu. Admin paneli üzerinden kullanıcı, rol, izin ve site yönetimi. Rol bazlı yetkilendirme sistemi.
...
![Claude AI](https://img.shields.io/badge/Claude_AI-FF7139?style=for-the-badge&logo=anthropic&logoColor=white)
![Azure](https://img.shields.io/badge/Azure_Face_API-0089D6?style=for-the-badge&logo=microsoft-azure&logoColor=white)
...
![Windsurf](https://img.shields.io/badge/Windsurf-0078D7?style=for-the-badge&logo=visual-studio-code&logoColor=white)
...
- 🤖 **AI-Powered Development:** Claude Code, Gemini CLI, Cursor ve Windsurf ile verimli kod geliştirme
- 🏗️ **Clean Architecture:** Sürdürülebilir ve test edilebilir yazılım mimarisi
- 🔄 **Microservices:** Kafka ve RabbitMQ ile dağıtık sistemler
- 🚀 **Modern Web Development:** ASP.NET Core ile performanslı web uygulamaları
- 📱 **Cross-Platform Mobile:** React Native ile çok platformlu mobil çözümler
- 🧪 **Test-Driven Development:** xUnit ve Moq ile kapsamlı test stratejileri

## 📫 İletişim

Benimle iletişime geçmekten çekinmeyin! Yeni projeler, işbirlikleri veya teknoloji hakkında sohbet etmek için her zaman açığım.

- **📧 Email:** [info@hamzacanturk.com](mailto:info@hamzacanturk.com)
- **💼 LinkedIn:** [linkedin.com/in/hamzacanturk](https://www.linkedin.com/in/hamzacanturk/)
- **🌐 Web:** [hamzacanturk.com](https://hamzacanturk.com/)
- **📂 GitHub:** [github.com/HamzaCanturk61](https://github.com/HamzaCanturk61)

---

<div align="center">
  <i>⚡ "Yapay zeka destekli araçlarla kod yazmanın geleceğini şekillendiriyorum" ⚡</i>
</div>
